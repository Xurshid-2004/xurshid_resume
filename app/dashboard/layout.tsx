...
import type { ResumeData, Language } from "./ResumeContext";
...
const T = {
  en: {
    ...
    add: "+ ADD", save: "Save", download: "Download PDF", saving: "Saving...",
  ...
  uz: {
    ...
    add: "+ QO'SHISH", save: "Saqlash", download: "PDF Yuklab Olish", saving: "Saqlanmoqda...",
  ...
  ru: {
    ...
    add: "+ ДОБАВИТЬ", save: "Сохранить", download: "Скачать PDF", saving: "Сохраняется...",
...
const InnerLayout = ({ children }: { children: ReactNode }) => {
  ...
  const skillTags = data.skills ? data.skills.split(",").slice(0, 3).map((s) => s.trim()) : [];
    ...
    <>
      ...
      <div className="min-h-screen bg-[#020617] text-slate-200 flex flex-col lg:flex-row font-sans overflow-hidden">
        ...
        <main className="flex-1 bg-[#020617] overflow-y-auto min-h-0">
          <div className="flex items-start justify-center p-4 lg:p-8 min-h-full">
            <div
              id="resume-print"
              ref={previewRef}
              style={{
